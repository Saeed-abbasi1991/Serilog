...
namespace NetStandardDemoLib
{
    ...
    {
        private const string _connectionString = @"data source=localhost\SADGAN;initial catalog = LogTest; persist security info=True; Integrated Security = SSPI;"; 
        //@"Server=(localhost)\SADGAN3\SADGAN;Database=LogTest;Integrated Security=SSPI;";
